...
class Datasets():
    ...
    def calc_mean_and_std(self):
        ...
        for i, file_path in enumerate(file_list):
            ...
            #########
            img = tf.image.resize_with_pad(img, hp.img_size, hp.img_size)
            #########
    ...
    def standardize(self, img):
        ...
        # TASK 1
        # TODONE: Standardize the input image. Use self.mean and self.std
    ...
    def get_data(self, path, is_vgg, shuffle, augment):
        ...
        if augment:
            # TODONEs: Use the arguments of ImageDataGenerator()
